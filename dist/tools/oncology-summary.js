...
import { getPatient, getConditions, getMedicationRequests, getObservations, getAppointments, } from '../fhir/client.js';
...
export async function oncologySummaryHandler() {
    ...
    const [fhirPatient, conditions, medRequests, observations, fhirAppts] = await Promise.all([
        ...
        getObservations(patientId, [...PANEL_CODES.CBC, ...PANEL_CODES.TUMOR_MARKERS], last30Days, 60),
...
//# sourceMappingURL=oncology-summary.js.map